...
public class R15RolboxAvatar {
	...
	public R15RolboxAvatar(String head, String upperTorso, String lowerTorso, String leftUpperArm, String leftLowerArm,
			...
			String leftLowerLeg, String leftFoot, String rightUpperLeg, String rightLowerLeg, String rightFoot) {
		super();
		this.head = head;
	...
	public String getRightLowerLeg() {
		return rightLowerLeg;
	}

	public void setRightLowerLeg(String rightLowerLeg) {
		this.rightLowerLeg = rightLowerLeg;
	}
